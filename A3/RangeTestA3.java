...
public class RangeTest {
    ...
    public void combineRangeLowerBoundNaNNull() {
    	...
    	Range actual = Range.combineIgnoringNaN(null, combineNaN1);
    	Range expected = new Range(Double.NaN, 5);
    ...
    public void combineRangeUpperBoundNaNNull() {
    	...
    	Range actual = Range.combineIgnoringNaN(null, combineNaN2);
    	Range expected = new Range(5, Double.NaN);
        assertEquals("The range after being combined with Range that is not-a-number should return Range(5, NaN) since NaN is ignored.",
        		expected, actual);
    }
    ...
    public void combineLowerBoundIsNAN() {
    	Range combineNaN1 = new Range(Double.NaN, 5);
    	Range combineNaN2 = new Range(Double.NaN, 10);
    ...
    public void combineUpperBoundIsNAN() {
        ...
        assertEquals("The range after being combined with Range that has a lower bound not-a-number should return Range(10, NaN) since NaN is ignored.",
        		expected, actual);
    }
